...
import Avatar from "../../../../assets/icons/image6.png"
...
const MenuTop: React.FC = () => {
  ...
  const options: Option[] = [
    { key: "img2", label: "Upscale", image: window_maximize },
    { key: "img3", label: "Adjust", image: adjustments_horizontal },
    { key: "img4", label: "Eraser", image: eraser },
    { key: "img5", label: "Extend", image: resize },
  ]
      ...
      <View style={styles.leftContainer}>
        <View style={styles.leftSection}>
          ...
          <TouchableOpacity
            style={[
              styles.iconLeft,
              selectedIcon === "click" && styles.selectedButton,
            ]}
          ...
          <TouchableOpacity
            style={[
              styles.iconLeft,
              selectedIcon === "stack" && styles.selectedButton,
            ]}
